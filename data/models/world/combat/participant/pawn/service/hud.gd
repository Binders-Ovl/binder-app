...
func update_character_health(pawn: TacticsPawn) -> void:
	...
	var _mana_label: Label3D = pawn.get_node("Character/CharacterUI/ManaLabel")
	var _act_label: Label3D = pawn.get_node("Character/CharacterUI/ActLabel")
	var _name_label: Label3D = pawn.get_node("Character/CharacterUI/NameLabel")
